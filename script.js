...
// Check if video is a Short based on aspect ratio detection
function detectShortFromThumbnail(videoId) {
    // For now, we'll use the known list + any future shorts
...
async function loadYouTubeVideos() {
    ...
    if (videos.length > 0) {
        ...
        console.log('Regular videos:', regularVideos.length, regularVideos.map(v => v.videoId));
        console.log('Shorts:', shorts.length, shorts.map(v => v.videoId));
